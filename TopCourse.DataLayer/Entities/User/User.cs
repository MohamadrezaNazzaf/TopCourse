...
namespace TopCourse.DataLayer.Entities.User
{
    public class User
    {
        ...
        public virtual List<UserRole> UserRoles { get; set; } // // Yek User Mitavanad n Ta Role Dashte Bashad.
        public virtual List<Wallet.Wallet> Wallets { get; set; }
        public virtual List<Course.Course> Courses { get; set; }
        public virtual List<Order.Order> Orders { get; set; }
        public List<UserCourse> UserCourses { get; set; } // Yek User Mitavanad n Ta UserCourse Dashte Bashad.
